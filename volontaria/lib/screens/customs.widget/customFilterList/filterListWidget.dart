...
import 'package:volontaria/screens/customs.widget/customFilterList/choiceChipWidget.dart';
import 'package:volontaria/screens/customs.widget/customFilterList/searchFieldWidget.dart';
          ...
          Column(
            children: <Widget>[
              ...
              widget.hideSelectedTextCount
                ...
                child: Text(_selectedTextList.length <= 1 ? '${_selectedTextList.length} filtre sélectionné' :
                  '${_selectedTextList.length} filtres sélectionnés',
